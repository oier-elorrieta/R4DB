...
public class metodoakPlaterZerrendak {
	...
	public static String[] platerMotak() throws SQLException {
	...
	public static String[] platerMota(String platerMota, String tipoa) throws SQLException {
		Connection konekzioa = ConnectionPool.getInstance().getConnection();
	...
	public static String[] platerMotaArabera(String platerMota) throws SQLException {
		Connection konekzioa = ConnectionPool.getInstance().getConnection();
	...
	public static int zenbatPlaterMotaBakoitzeko(String platerMota) throws SQLException {
		Connection konekzioa = ConnectionPool.getInstance().getConnection();
	...
	public static int jasoPlaterKodea(String platerra) throws SQLException {
		Connection konekzioa = ConnectionPool.getInstance().getConnection();
		int platerKodea = 0;
